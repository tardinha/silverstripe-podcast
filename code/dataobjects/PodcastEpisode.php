...
class PodcastEpisode extends DataObject {
  ...
  public function getCMSFields() {
    ...
    $fields->fieldByName('Root.Main.EpisodeFile')->setFolderName('podcast/episodes')->getValidator()->setAllowedExtensions(array(
        'pdf',
        'zip',
        'doc',
        'docx',
    ...
    $fields->fieldByName('Root.Main.EpisodeImage')->setFolderName('podcast/episode-images')->getValidator()->setAllowedExtensions(array(
        'jpg',
        'png'
      ));
