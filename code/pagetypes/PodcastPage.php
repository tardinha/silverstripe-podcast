...
class PodcastPage extends Page {
  ...
  public function getCMSFields() {
    ...
    $podcastImage->setFolderName('podcast/podcast-artwork')->setDescription("iTunes recommends a size of at least 1400x1400")->getValidator()->setAllowedExtensions(array(
        'jpg',
        'png'
      ));
...
class PodcastPage_Controller extends Page_Controller {
  ...
  public function paginatedPodcastEpisodes() {
    $paginatedList = new PaginatedList(PodcastEpisode::get()->filter(array(
          'BlockEpisode' => '0'
        ))->sort('EpisodeDate', 'DESC') , $this->request);
